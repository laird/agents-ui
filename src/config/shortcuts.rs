...
pub struct Shortcut {
    ...
    #[allow(dead_code)] // Planned: used when shortcut dispatch target is wired up
    pub target: String,
    /// If true, send as raw tmux key (e.g., "C-c") instead of text+Enter.
    #[serde(default)]
    #[allow(dead_code)] // Planned: used when raw key dispatch is implemented
    pub raw: bool,
}
...
impl ShortcutsConfig {
    ...
    #[allow(dead_code)] // Planned: used when shortcut commands are dispatched
